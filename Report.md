...
Another normative theory that has been used to support stakeholder theory is the principle of fairness. Fairness among the stakeholders is an important issue and according to Harry **(8)** , consent is the solution to it. Fairness is an emotive term because it is people that can feel either fair or unfair as an emotion. The principle of fairness requires the manager of the firm to treat all stakeholders fairly including those powerless stakeholders. A good example is the environment. It is true that we shouldn't exploit environment at will since such action will certainly bring long term negative effect on the performance of firm. However, the principle of fairness suggest there's also an ethical issue in harming the environment because it's being treated unfairly. While environment is powerless, firm should consider its interest in the decision making because it should be treated fairly. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNTE0MDY2MjksLTExNjc1NDU3MSw0NT
c5MzQzNDksMjIwODYyOTEzLDM0Mjk4OTI3NywxMDUzMjI5NjM5
LC0xNDcxMDc4NjQ4LC05NzkzNjExNjQsLTg2OTUyMTAzNV19
-->